...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_16->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 239, 245)"));

        gridLayout_3->addWidget(pushButton_16, 11, 3, 1, 1);
        ...
        gridLayout_3->addWidget(pushButton_8, 5, 2, 1, 1);
        ...
        pushButton_14->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 239, 245)"));

        gridLayout_3->addWidget(pushButton_14, 5, 3, 1, 1);
        ...
        pushButton_3->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 239, 245)"));

        gridLayout_3->addWidget(pushButton_3, 11, 0, 1, 1);
        ...
        pushButton_13->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 239, 245)"));
        ...
        pushButton_15->setStyleSheet(QString::fromUtf8("background-color: rgb(192, 214, 255)"));

        gridLayout_3->addWidget(pushButton_15, 11, 2, 1, 1);
        ...
        pushButton_12->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 239, 245)"));

        gridLayout_3->addWidget(pushButton_12, 1, 3, 1, 1);
        ...
        pushButton_2->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 239, 245)"));

        gridLayout_3->addWidget(pushButton_2, 11, 1, 1, 1);
        ...
        pushButton_17->setMinimumSize(QSize(100, 70));
        QFont font1;
        font1.setPointSize(14);
        pushButton_17->setFont(font1);
        pushButton_17->setStyleSheet(QString::fromUtf8("background-color: rgb(192, 214, 255)"));
        ...
        QObject::connect(pushButton_9, SIGNAL(clicked()), MainWindow, SLOT(press6()));
        QObject::connect(pushButton_6, SIGNAL(clicked()), MainWindow, SLOT(press2()));
        QObject::connect(pushButton_3, SIGNAL(clicked()), MainWindow, SLOT(comma()));
        QObject::connect(pushButton_16, SIGNAL(clicked()), MainWindow, SLOT(plus()));
        QObject::connect(pushButton_7, SIGNAL(clicked()), MainWindow, SLOT(press1()));
        QObject::connect(pushButton_13, SIGNAL(clicked()), MainWindow, SLOT(divide()));
        QObject::connect(pushButton_8, SIGNAL(clicked()), MainWindow, SLOT(press3()));
        QObject::connect(pushButton_14, SIGNAL(clicked()), MainWindow, SLOT(minus()));
        QObject::connect(pushButton_11, SIGNAL(clicked()), MainWindow, SLOT(press4()));
        QObject::connect(pushButton_4, SIGNAL(clicked()), MainWindow, SLOT(press8()));
        QObject::connect(pushButton_10, SIGNAL(clicked()), MainWindow, SLOT(press5()));
        QObject::connect(pushButton_5, SIGNAL(clicked()), MainWindow, SLOT(press9()));
        QObject::connect(pushButton_15, SIGNAL(clicked()), MainWindow, SLOT(equal()));
        QObject::connect(pushButton, SIGNAL(clicked()), MainWindow, SLOT(press7()));
        QObject::connect(pushButton_12, SIGNAL(clicked()), MainWindow, SLOT(multiply()));
        QObject::connect(pushButton_2, SIGNAL(clicked()), MainWindow, SLOT(press0()));
        QObject::connect(pushButton_17, SIGNAL(clicked()), MainWindow, SLOT(clear()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_11->setText(QCoreApplication::translate("MainWindow", "4", nullptr));
        ...
        pushButton_5->setText(QCoreApplication::translate("MainWindow", "9", nullptr));
        ...
        pushButton_17->setText(QCoreApplication::translate("MainWindow", "C", nullptr));
